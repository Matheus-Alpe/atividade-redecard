...
public class DesagendamentoParcelas {
	...
	public void setOriginalPV(String originalPV) {
		this.originalPV = originalPV;
	}
	public String getOriginalRV() {
		return originalRV;
	}
	public void setOriginalRV(String originalRV) {
		this.originalRV = originalRV;
	}
